...
Extract ONLY the rows where the Position (or Quantity) column has a non-blank value. Skip every row where that column is empty — those are quotes with no holding.
...
- "position": the signed integer from the Position column
- "last": the numeric value from the Last / Lmt Price column, as a plain number
